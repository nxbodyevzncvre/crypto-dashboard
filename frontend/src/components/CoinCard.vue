<template>
  <div
    class="bg-slate-900 border border-slate-800 rounded-xl p-5 cursor-pointer transition-all
           hover:border-slate-700 hover:-translate-y-1 hover:shadow-xl hover:shadow-black/20"
